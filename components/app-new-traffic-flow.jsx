...
export default function AppNewFlow(props) {
  ...
  }, [isOnline, props?.selectedJunctions, props?.selectedTab, props?.date])
          ...
          <div>
            <Marker
              ...
              onClick={(e) => {
                ...
                // console.log("selectedChannels", selectedChannels,storeData[0]?.patterndatalist);
                // setSelectedCams(selectedChannels)
  ...
  useEffect(() => {
    if (props?.selectedJunctions === null) {
      setZoomData(4)
    } else if (
      props?.selectedJunctions !== null ||
      props?.selectedJunctions !== undefined
                  ...
                  {popupInfo?.datalist.length > 0 ? (
                    <div className="text-md grid p-2 text-sky-500">
                      ...
                      <span className="text-[#000] font-medium">
                        {" "}
                        Total Traffic Flow: {popupInfo?.totalSum}{" "}
                      </span>
