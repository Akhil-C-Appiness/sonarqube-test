...
export default function RecentFilteroptions({
  onCheckboxChange,
  colorfilterValues,
  regTypeValues,
  onChangereg,
  ...
  return (
    <Popover>
      <PopoverTrigger className="flex flex-row items-center gap-2 border rounded-md p-[9px]">
        Filter Options{" "}
      ...
      <PopoverContent>
        <Tabs defaultValue="select">
          ...
          <TabsContent value="select" className="p-1">
            ...
            <hr />
            <div className="flex items-center justify-between p-0 mt-6">
